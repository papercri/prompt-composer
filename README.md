...
- Registro de cuenta nueva con email y contraseña, con validación de formato de email y de contraseña (mínimo 3 letras y 3 números).
...
1. Inicia sesión con Google o con email y contraseña. También puedes registrarte con una cuenta nueva desde la pantalla de inicio.
...
Para probar la app sin registrarte, usa:
